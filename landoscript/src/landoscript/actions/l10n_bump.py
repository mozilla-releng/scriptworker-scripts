...
async def run(github_client, github_config, public_artifact_dir, branch, l10n_bump_info, dontbuild, ignore_closed_tree):
    ...
    for bump_config in l10n_bump_info:
        ...
        async with GithubClient(github_config, l10n_owner, l10n_repo) as l10n_github_client:
            # some of these may be re-usable from version_bump ?
            ...
            old_contents = json.loads(orig_files[bump_config["path"]])
