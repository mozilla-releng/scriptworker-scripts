...
from signingscript.task import download_files, task_cert_type, task_signing_formats, validate_task_schema
...
class PushApkContext(Context):
    ...
    def __init__(self):
        super(PushApkContext, self).__init__()
...
def get_default_config():
    ...
    data_dir = os.path.join(cwd, 'signingscript', 'data')
