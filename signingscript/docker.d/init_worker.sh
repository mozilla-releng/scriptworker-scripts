...
export AUTHENTICODE_CERT_PATH_202412=$APP_DIR/signingscript/src/signingscript/data/authenticode_dep.crt
export AUTHENTICODE_CERT_PATH_202404="$AUTHENTICODE_CERT_PATH_202412"
export AUTHENTICODE_CERT_PATH="$AUTHENTICODE_CERT_PATH_202412"
export AUTHENTICODE_CERT_PATH_EV="$AUTHENTICODE_CERT_PATH"
export AUTHENTICODE_CERT_PATH_EV_202412="$AUTHENTICODE_CERT_PATH"
export AUTHENTICODE_CA_PATH_202412=$APP_DIR/signingscript/src/signingscript/data/authenticode_dep_ca.crt
export AUTHENTICODE_CA_PATH_202404="$AUTHENTICODE_CA_PATH_202412"
export AUTHENTICODE_CA_PATH="$AUTHENTICODE_CA_PATH_202412"
export AUTHENTICODE_CA_PATH_EV="$AUTHENTICODE_CA_PATH"
export AUTHENTICODE_CA_PATH_EV_202412="$AUTHENTICODE_CA_PATH"
...
if [ "$ENV" == "prod" ]; then
  export AUTHENTICODE_TIMESTAMP_STYLE=old
  export AUTHENTICODE_CERT_PATH_202412=$APP_DIR/signingscript/src/signingscript/data/authenticode_prod_202412.crt
  export AUTHENTICODE_CERT_PATH_202404=$APP_DIR/signingscript/src/signingscript/data/authenticode_prod_202404.crt
  export AUTHENTICODE_CERT_PATH="$AUTHENTICODE_CERT_PATH_202404"
  export AUTHENTICODE_CERT_PATH_EV=$APP_DIR/signingscript/src/signingscript/data/authenticode_prod_ev.crt
  export AUTHENTICODE_CERT_PATH_EV_202412=$APP_DIR/signingscript/src/signingscript/data/authenticode_prod_ev_202412.crt
  export AUTHENTICODE_CA_PATH_202412=$APP_DIR/signingscript/src/signingscript/data/authenticode_prod_ca_202412.crt
  export AUTHENTICODE_CA_PATH_202404="$AUTHENTICODE_CA_PATH_202412"
  export AUTHENTICODE_CA_PATH="$AUTHENTICODE_CA_PATH_202412"
