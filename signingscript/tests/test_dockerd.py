...
PWD_TEST_VARIABLES = {
    ...
    for p in (
        ...
        "AUTOGRAPH_AUTHENTICODE_GCP_PROD_EV_PASSWORD",
        "AUTOGRAPH_AUTHENTICODE_GCP_PROD_EV_USERNAME",
        ...
        "AUTOGRAPH_STAGE_AUTHENTICODE_EV_USERNAME",
        "AUTOGRAPH_STAGE_AUTHENTICODE_EV_PASSWORD",
        "AUTOGRAPH_STAGE_AUTHENTICODE_SHA2_USERNAME",
        "AUTOGRAPH_STAGE_AUTHENTICODE_SHA2_PASSWORD",
        "AUTOGRAPH_STAGE_FENIX_MOZILLA_ONLINE_USERNAME",
        "AUTOGRAPH_STAGE_FENIX_MOZILLA_ONLINE_PASSWORD",
        "AUTOGRAPH_STAGE_FENIX_USERNAME",
        "AUTOGRAPH_STAGE_FENIX_PASSWORD",
        "AUTOGRAPH_STAGE_FENNEC_RELEASE_USERNAME",
        "AUTOGRAPH_STAGE_FENNEC_RELEASE_PASSWORD",
        ...
        "AUTOGRAPH_STAGE_MAR_NIGHTLY_USERNAME",
        "AUTOGRAPH_STAGE_MAR_NIGHTLY_PASSWORD",
        "AUTOGRAPH_STAGE_MAR_USERNAME",
        "AUTOGRAPH_STAGE_MAR_PASSWORD",
        "AUTOGRAPH_STAGE_MAR_RELEASE_USERNAME",
        "AUTOGRAPH_STAGE_MAR_RELEASE_PASSWORD",
        "AUTOGRAPH_STAGE_MOZILLAVPN_ADDONS_USERNAME",
        "AUTOGRAPH_STAGE_MOZILLAVPN_ADDONS_PASSWORD",
        "AUTOGRAPH_STAGE_MOZILLAVPN_DEBSIGN_USERNAME",
        "AUTOGRAPH_STAGE_MOZILLAVPN_DEBSIGN_PASSWORD",
        "AUTOGRAPH_STAGE_MOZILLAVPN_USERNAME",
