...
PWD_TEST_VARIABLES = {
    ...
    for p in (
        ...
        "AUTOGRAPH_XPI_PRIVILEGED_PASSWORD",
        "AUTOGRAPH_XPI_PRIVILEGED_USERNAME",
        "AUTOGRAPH_STAGE_XPI_PASSWORD",
        "AUTOGRAPH_STAGE_XPI_USERNAME",
        "AUTOGRAPH_STAGE_XPI_PRIVILEGED_PASSWORD",
