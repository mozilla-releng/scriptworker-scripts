...
@pytest.mark.parametrize(
    ...
    (
        ...
        ({"firefox-beta-langpack-latest-ssl": "Firefox-110.0b1-langpack-SSL"}, False),
        ...
        ({"firefox-langpack-latest-ssl": "Firefox-110.0b1-langpack-SSL"}, True),
        ({"firefox-langpack-latest-ssl": "Firefox-110.0-langpack-SSL"}, False),
        ...
        ({"firefox-esr115-latest": "Firefox-115.1.0esr"}, False),
        ({"firefox-esr115-latest-ssl": "Firefox-115.1.2esr-SSL"}, False),
        ({"firefox-esr115-latest": "Firefox-70.2.1"}, True),
        ({"firefox-esr115-latest-ssl": "Firefox-70.0b1-SSL"}, True),
        ({"firefox-esr115-latest": "Firefox-128.1.0esr"}, True),
        ({"firefox-esr115-latest-ssl": "Firefox-128.1.0esr-SSL"}, True),
        ({"firefox-esr115-latest": "Firefox-115.1.0esr", "firefox-esr115-latest-ssl": "Firefox-115.1.2esr-SSL"}, False),
        ({"firefox-sha1": "Firefox-52.7.2esr-sha1"}, True),
        ({"firefox-sha1-ssl": "Firefox-52.7.2esr-sha1"}, True),
        ({"firefox-sha1": "Firefox-70.1.0esr"}, True),
        ({"firefox-sha1-ssl": "Firefox-70.1.2esr"}, True),
        ({"firefox-sha1": "Firefox-52.7.2esr-sha1", "firefox-sha1-ssl": "Firefox-70.1.2esr-sha1"}, True),
        ...
        ({"thunderbird-beta-msix-latest-ssl": "Thunderbird-70.0b2-msix-SSL"}, False),
...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            ("Thunderbird-67.0b2-msix-SSL", "/thunderbird/releases/67.0b2/win64/multi/Thunderbird%20Setup%2067.0b2.msix", False),
            ("Thunderbird-115.0.2-msix-SSL", "/thunderbird/releases/115.0.2/win64/multi/Thunderbird%20Setup%20115.0.2.msix", False),
