...
def supported_hg():
    ...
    return util.versiontuple(n=2) in ((4, 3), (4, 4), (4, 5), (4, 6), (4, 7))
...
def _docheckout(
    ...
    if url in ("https://hg.mozilla.org/try", "https://hg.mozilla.org/try-comm-central"):
        if repo[checkoutrevision].phase() == phases.public:
            ui.write(
                _(
                    "error: phase of revision is public; this is likely "
