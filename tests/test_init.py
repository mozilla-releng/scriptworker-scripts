...
CONTEXT = {
    ...
    re.compile(r"pushapk:.*"): {
        ...
        "VIVO_ACCESS_KEY": "Zm9vYmFyCg==",
        "VIVO_ACCESS_SECRET": "Zm9vYmFyCg==",
    },
    ...
    re.compile(r"signing:.*"): {
        ...
        "AUTOGRAPH_RPMSIGN_PASSWORD": "1",
        "AUTOGRAPH_RPMSIGN_USERNAME": "1",
        ...
        "AUTOGRAPH_STAGE_RPMSIGN_PASSWORD": "1",
        "AUTOGRAPH_STAGE_RPMSIGN_USERNAME": "1",
