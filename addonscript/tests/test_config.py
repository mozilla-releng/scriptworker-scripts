...
def load_schema():
    path_to_schema = os.path.join(os.path.dirname(__file__), "..", "src", "addonscript", "data", "config_schema.json")
...
def test_prod():
    context = {"ENV": "prod", "AMO_SERVER": "", "JWT_USER": "", "JWT_SECRET": "", "COT_PRODUCT": "", "TASKCLUSTER_SCOPE_PREFIX": ""}
    _validate_config(context)


def test_fake_prod():
    context = {"ENV": "fake-prod", "AMO_SERVER": "", "JWT_USER": "", "JWT_SECRET": "", "COT_PRODUCT": "", "TASKCLUSTER_SCOPE_PREFIX": ""}
    _validate_config(context)
