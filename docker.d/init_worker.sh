...
case $ENV in
  ...
  prod)
    ...
    test $MACAROON_ESR
    export MACAROON_BETA_PATH=$CONFIGDIR/beta_macaroon.cfg
    export MACAROON_CANDIDATE_PATH=$CONFIGDIR/candidate_macaroon.cfg
    export MACAROON_ESR_PATH=$CONFIGDIR/esr_macaroon.cfg
