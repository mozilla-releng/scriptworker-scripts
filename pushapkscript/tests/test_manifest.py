...
@pytest.mark.parametrize("does_apk_have_expected_digest, raises", ((True, False), (False, True)))
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            {"AndroidManifest.xml": {"SHA1-Digest": "some-base64-hash"}, "application.ini": {"SHA1-Digest": "another-base64-hash"}},
        ),
        (
            [
                "Manifest-Version: 1.0\n",
            ...
            {
                "AndroidManifest.xml": {"SHA-256-Digest": "some-base64-sha256", "SHA1-Digest": "some-base64-sha1"},
                "application.ini": {"SHA-256-Digest": "another-base64-sha256", "SHA1-Digest": "another-base64-sha1"},
            },
        ),
        (
            [
        ...
        (
            ...
            ],
            {
                ...
                "some/super-duper/real/looooooooooooooooooooooooooooooooooooooooong-file-name.png": {"SHA1-Digest": "another-base64-hash"},
            },
        ),
        (
            [
...
@pytest.mark.parametrize(
    "digest, manifest_data, expected",
    (
        ("SHA1", {}, False),
        ("SHA1", {"AndroidManifest.xml": {"SHA1-Digest": "some-base64-hash"}, "application.ini": {"SHA1-Digest": "some-base64-hash"}}, True),
        ("SHA-256", {"AndroidManifest.xml": {"SHA-256-Digest": "some-base64-hash"}, "application.ini": {"SHA-256-Digest": "some-base64-hash"}}, True),
        (
            "SHA1",
            {
                "AndroidManifest.xml": {"SHA1-Digest": "some-base64-hash", "SHA-256-Digest": "some-base64-hash"},
                "application.ini": {"SHA1-Digest": "some-base64-hash", "SHA-256-Digest": "some-base64-hash"},
            },
            True,
        ),
        (
        ...
        ("SHA1", {"AndroidManifest.xml": {"SHA-256-Digest": "some-base64-hash"}, "application.ini": {"SHA-256-Digest": "some-base64-hash"}}, False),
        (
            "SHA1",
