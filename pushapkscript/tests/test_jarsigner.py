...
class JarSignerTest(unittest.TestCase):
    def setUp(self):
        ...
        self.context.task = {"scopes": ["project:releng:googleplay:aurora"], "payload": {}}

        self.minimal_context = MagicMock()
        self.minimal_context.config = {"jarsigner_key_store": "/path/to/keystore", "taskcluster_scope_prefixes": ["project:releng:googleplay:"]}
        self.minimal_context.task = {"scopes": ["project:releng:googleplay:aurora"], "payload": {}}
