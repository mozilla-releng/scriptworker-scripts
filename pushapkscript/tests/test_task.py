...
@pytest.mark.parametrize(
    ...
    (
        ...
        (["project:mobile:focus:googleplay:product:"], ["project:mobile:focus:googleplay:product:focus"], False, "focus"),
        (
        ...
        (["project:mobile:focus:googleplay:product:"], [], True, None),
        ([], ["project:mobile:focus:googleplay:product:focus"], True, None),
        ...
        (
            ...
            ["project:mobile:focus:releng:googleplay:product:focus", "project:mobile:reference_browser:releng:googleplay:product:reference_browser"],
            True,
            None,
        ),
    ),
