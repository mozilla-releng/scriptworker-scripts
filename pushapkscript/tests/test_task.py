...
def context():
    context_ = Context()
    context_.config = {"schema_file": os.path.join(os.path.dirname(pushapkscript.__file__), "data/pushapk_task_schema.json")}
    return context_
...
@pytest.mark.parametrize(
    ...
    (
        {
            ...
            "dependencies": ["TjtRhOazQJ6_lNYYDMjAGA", "R-GBCWrDQiW7UP1nPALXMg", "TmzjU_G6ReepFBGOCATlpw"],
            ...
            "payload": {
                "upstreamArtifacts": [
                    {"paths": ["public/build/target.apk"], "taskId": "TjtRhOazQJ6_lNYYDMjAGA", "taskType": "signing"},
                    {"paths": ["public/build/target.apk"], "taskId": "TmzjU_G6ReepFBGOCATlpw", "taskType": "signing"},
                ],
    ...
    ([Treeherder push](https://treeherder.mozilla.org/#/jobs?repo=mozilla-beta&revision=35a1b06fe7863e118ce831d9056ad20501eec606))",
            ...
            "tags": {"createdForUser": "r@m.c"},
            "extra": {
                "treeherderEnv": ["production", "staging"],
                "treeherder": {
                    "jobKind": "other",
                    "groupSymbol": "pub",
                    "collection": {"opt": True},
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (["project:releng:googleplay:product:"], ["project:releng:googleplay:product:focus-android"], False, "focus-android"),
        (
        ...
        (["project:releng:googleplay:product:"], [], True, None),
        ([], ["project:releng:googleplay:product:focus"], True, None),
        (["project:releng:googleplay:"], ["project:releng:googleplay:beta", "project:releng:googleplay:release"], True, None),
        (
            ["project:releng:googleplay:", "project:releng:googleplay"],
            ["project:releng:googleplay:beta", "project:releng:googleplay:product:focus-android"],
            True,
            None,
        ),
        (
        ...
        (
            ["project:releng:googleplay", "project:mobile:reference_browser:releng:googleplay:"],
            [
