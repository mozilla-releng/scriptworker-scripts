...
def set_up_mocks(monkeypatch_, edit_service_mock_):
    ...
    monkeypatch_.setattr(checker, 'cross_check_apks', lambda _, __, ___, ____, _____, ______, _______: None)
...
def test_do_not_contact_google_play_flag_does_not_request_google_play(monkeypatch):
    ...
    monkeypatch.setattr(checker, 'cross_check_apks', lambda _, __, ___, ____, _____, ______, _______: None)
